                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="<?= base_url('auth/getlogin'); ?>" method="post">
                                    ...
                                    <div class="text-center">
                                        <a class="small daftar" href="javascript:;">Create an Account!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
